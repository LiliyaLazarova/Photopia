...
public class PostDAO {
	...
	public void uploadPost(int userId, IPost post) throws ClassNotFoundException, SQLException, PostException {
		...
		try {
			...
			throw new PostException("Upload post failed!",e);
		}

	}

	public List<Post> getAllPostsUrls(int userId) throws ClassNotFoundException, SQLException, PostException {
		...
		try {
			...
			throw new PostException("Failed to get all posts!");
		}
	...
	public Post getInfoToShowPost(int postId) throws ClassNotFoundException, SQLException, PostException {
		Connection connection = new DBConnection().getConnection();
