...
public class NewsfeedDAO {
	...
	private static final String GET_LIKERS_NAMES_AND_TIME = "select user_name,timestamp from users u"
			+ " join likes l on (u.user_id=l.user_id)" + " join posts p on(l.post_id=p.post_id)"
			+ " where p.user_id=?;";

	public Set<NewsFeed> getMyFollowersNames(int currentUserId)
			throws NewsfeedException, ClassNotFoundException, SQLException {
	...
	public Set<NewsFeed> getMyCommentersNames(int currentUserId)
			throws NewsfeedException, ClassNotFoundException, SQLException {
	...
	public Set<NewsFeed> getMyLikersNames(int currentUserId)
			throws NewsfeedException, ClassNotFoundException, SQLException {
